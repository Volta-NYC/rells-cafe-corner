  ...
  return (
    <section id="home" className="relative flex min-h-screen items-end overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-24 pt-36 md:px-8 md:pb-28"
      >
        ...
        <h1 className="max-w-5xl font-heading text-5xl uppercase leading-[0.95] text-white sm:text-7xl lg:text-8xl">
          Feeling a little <span className="saucy-glow">saucy?</span>
        </h1>
        ...
        <div className="mt-9 flex flex-col gap-4 sm:flex-row">
          <Link href="#menu" className="rounded-full bg-cafe-gold px-7 py-4 text-center text-sm font-extrabold uppercase text-cafe-black transition hover:bg-cafe-orange">
            View Menu
          </Link>
          <a href="https://rellscafecorner.com/" target="_blank" rel="noreferrer" className="rounded-full border border-white/35 px-7 py-4 text-center text-sm font-extrabold uppercase text-white transition hover:border-cafe-gold hover:text-cafe-gold">
            Order Now
          </a>
        </div>
      </motion.div>
